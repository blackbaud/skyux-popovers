...
describe('Dropdown', () => {
  ...
  function validateAll() {
    ...
    it('should match dropdown button screenshot when open', async (done) => {
      ...
      await element(by.css('#screenshot-dropdown-button .sky-dropdown-button')).click();
    ...
    it('should match dropdown button screenshot when dropdown item is focused', async (done) => {
      ...
      const buttonEl = element(by.css('#screenshot-dropdown-button .sky-dropdown-button'));
    ...
    it('should match dropdown context menu screenshot when open', async (done) => {
      ...
      await element(by.css('#screenshot-dropdown-context-menu .sky-dropdown-button')).click();
    ...
    it('should match dropdown screenshot when before a relative element', async (done) => {
      ...
      await element(by.css('#screenshot-dropdown-z-index .sky-dropdown-button')).click();
    ...
    it('should match dropdown screenshot when menu items overflow dropdown', async (done) => {
      ...
      await element(by.css('#screenshot-dropdown-max-height .sky-dropdown-button')).click();
